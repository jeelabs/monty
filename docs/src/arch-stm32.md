...
* `verify/s_blinker.py` - blink the Nucleo's on-board LED on pin PB3
* `verify/s_spi.py` - define an SPI bus on pins PB7, PB6, PB0, and PA12
* `verify/s_rf69.py` - connect to the RFM69 and report any received packets
